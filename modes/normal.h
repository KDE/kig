...
class NormalMode : public BaseMode
{
public:
...
protected:
    ...
    void dragObject(const std::vector<ObjectHolder *> &os, const QPoint &pointClickedOn, KigWidget &w, bool ctrlOrShiftDown) override;
