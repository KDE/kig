...
public:
  ...
  // of course..
  // some MenuActions..
  Q3PtrList<KAction> aMNewSegment;
  Q3PtrList<KAction> aMNewPoint;
  Q3PtrList<KAction> aMNewCircle;
  Q3PtrList<KAction> aMNewLine;
  Q3PtrList<KAction> aMNewOther;
  Q3PtrList<KAction> aMNewAll;
  Q3PtrList<KAction> aMNewConic;
