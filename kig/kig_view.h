...
public:
     ...
     * fullscreen widget.
     */
    KigWidget(KigPart *doc, KigView *view, QWidget *parent = nullptr, bool fullscreen = false);
    ~KigWidget();
...
public:
    explicit KigView(KigPart *part, bool fullscreen = false, QWidget *parent = nullptr);
    ~KigView();
