...
inline KAboutData kigAboutData(const char *name)
{
    KAboutData tmp(name,
                   i18n("Kig"),
                   KIG_VERSION_STRING,
                   i18n("KDE Interactive Geometry"),
                   KAboutLicense::GPL,
                   i18n("(C) 2002-2005, The Kig developers"),
                   QString(),
                   QStringLiteral("https://edu.kde.org/kig"));

    tmp.addAuthor(i18n("David E. Narvaez"), i18n("Current maintainer."), QStringLiteral("david.narvaez@computer.org"));

    tmp.addAuthor(i18n("Dominique Devriese"), i18n("Original author, former maintainer, design and lots of code."), QStringLiteral("devriese@kde.org"));
    ...
    tmp.addAuthor(i18n("Petr Gajdos"), i18n("Contributed the Bézier curves and related icons."), QStringLiteral("pgajdos@suse.cz"));

    tmp.addAuthor(i18n("Raoul Bourquin"), i18n("Contributed the 'asymptote' export filter."), QStringLiteral("raoulb@bluewin.ch"));
    ...
    tmp.addCredit(i18n("Christophe Prud'homme"), i18n("Contributed a patch for some bugs."), QStringLiteral("prudhomm@mit.edu"));
    ...
    tmp.addCredit(i18n("David Vignoni"), i18n("Responsible for the nice application SVG Icon."), QStringLiteral("david80v@tin.it"));

    tmp.addCredit(i18n("Danny Allen"), i18n("Responsible for the new object action icons."), QStringLiteral("danny@dannyallen.co.uk"));
