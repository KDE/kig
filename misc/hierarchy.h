...
// 		   QString description,
  ...
  void addParent ( HierarchyElement* e ) { parents.push_back(e); };
...
// interrelationships
// it is used in loading and saving, and for MacroObject's
class ObjectHierarchy
{
  ElemList allElems;
  ElemList gegElems;
...
public:
  ...
  // to the hierarchy it keeps.  All newly created objects are returned.
