...
const Transformation Transformation::harmonicHomology(const Coordinate &center, const LineData &axis)
{
...
const Transformation Transformation::affinityGI3P(const std::vector<Coordinate> &FromPoints, const std::vector<Coordinate> &ToPoints, bool &valid)
{
...
const Transformation Transformation::projectivityGI4P(const std::vector<Coordinate> &FromPoints, const std::vector<Coordinate> &ToPoints, bool &valid)
{
    ...
    double row0[13], row1[13], row2[13], row3[13], row4[13], row5[13], row6[13], row7[13], row8[13], row9[13], row10[13], row11[13];

    double *matrix[12] = {row0, row1, row2, row3, row4, row5, row6, row7, row8, row9, row10, row11};
...
const Transformation Transformation::castShadow(const Coordinate &lightsrc, const LineData &l)
{
...
const Transformation Transformation::projectiveRotation(double alpha, const Coordinate &d, const Coordinate &t)
{
    Transformation ret;
...
const Coordinate Transformation::apply(const double x0, const double x1, const double x2) const
{
...
{
    assert(isHomothetic());
    double det = mdata[1][1] * mdata[2][2] - mdata[1][2] * mdata[2][1];
...
const Transformation Transformation::similitude(const Coordinate &center, double theta, double factor)
{
    Transformation ret;
