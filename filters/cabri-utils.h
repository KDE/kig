 ...
 */
enum CabriVersion { CV_1_0, CV_1_2 };
...
class CabriObject_v10 : public CabriObject
{
public:
    CabriObject_v10();
...
class CabriObject_v12 : public CabriObject
{
public:
    CabriObject_v12();
...
class CabriReader_v10 : public CabriReader
{
public:
...
class CabriReader_v12 : public CabriReader
{
private:
    static void initColorMap();
